...
class ApprovalController extends Controller {
    ...
    /**
     * Loads the blade page with attributes
     *
     * @return $this
     */
    ...
    /**
     * View all the requested procurement requests
     *
     * @return $this
     */
    ...
    Public function UpdateChanges()
    {
        ...
        try
        {
            ...
            /* If cancel, changes are not saved */
...
//              get values from blade
                ...
                /* Check whether there are changes or not */
                ...
                /* If there are changes then save it */
    ...
    Public function ApproveRequest()
    {
        ...
        try
        {
            ...
            /* Get all the values from blade page*/
    ...
    /**
     * Downloads the relevant attachment
     * @param $id
     *
     * @return mixed
     */
