...
class FtpController extends Controller
{
    ...
    /**
     * Load the page with relevant attributes
     *
    ...
    /**
     * Load the connectivity blade page
     *
     * @return $this
     */
    ...
    public function SendConnRequest()
    {
        try
        {
            ...
            if ($send)
            {
                ...
                /* If request is not there for project, create the request*/
...
//                }
            ...
            /* view connectivity requests for each and every project */
    ...
    /**
     * Send ftp and shared folder request
     *
     * @return \Illuminate\View\View
     */
    ...
    public function Ftp()
    {
        try
        {
            ...
            if ($folder)
            {
                ...
                /* If the requests are not selected */
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        /** Check whether the ftp account check box is checked */
